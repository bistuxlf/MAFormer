...
class Model(nn.Module):
    def __init__(self, len_parts, num_classes, num_joints,
                 ...
                 att_drop=0, dropout=0, dropout2d=0, graphw_norm=False, factor=2):
        super().__init__()
...
class Graphformer_Block(nn.Module):
    def __init__(self, in_channels, out_channels, qkv_dim,
                 ...
                 kernel_size, use_pes=True, att_drop=0, factor=8):
        super().__init__()
        ...
        #self.out_nett = nn.Sequential(EMA(out_channels, factor=32), nn.BatchNorm2d(out_channels))
